/**
 * Clean Commercial SaaS Sidebar Navigation Component
 */
...
export function renderSidebar() {
  return `
    <aside class="app-sidebar">
      <div class="sidebar-header">
        <a href="javascript:void(0)" class="brand-badge" id="brandHomeLink">
          ...
          <div>
            ...
            <span class="brand-subtitle">Experiência do Cliente</span>
          </div>
        </a>
      </div>
      ...
      <div class="sidebar-footer" id="sidebarFooterTechBlock" style="display:none; border-top:1px solid var(--border-subtle); padding-top:0.6rem;">
        <button class="mode-switcher-btn" id="btnSwitchPublicSurvey" style="width:100%; text-align:left; background:transparent; border:none; color:var(--text-muted); font-size:0.75rem; padding:0.3rem 0; cursor:pointer;">
          📱 Simulador Aluno
        </button>
        <button class="mode-switcher-btn" id="btnSwitchKiosk" style="width:100%; text-align:left; background:transparent; border:none; color:var(--text-muted); font-size:0.75rem; padding:0.3rem 0; cursor:pointer;">
          🖥️ Modo Tablet Totem
        </button>
      </div>
    </aside>
